...
class Shop2State extends State<Shop2> {
  ...
  List<Color> color;
  List<Color> colors;
  static final GlobalKey<ScaffoldState> _scaffoldKeys =
                        ...
                        child: Padding(
                            child: Row(
                              children: [
                                ...
                                GestureDetector(
                                    child: ImageIcon(
                                        AssetImage(UIData.notification),
                                        color: Colors.white),
                                    onTap: () => _scaffoldKeys.currentState
                                        .openDrawer()),
                              ],
                      ...
                      Expanded(
                        child: SingleChildScrollView(
                          child: Column(children: <Widget>[
                            ...
                            Padding(
                                padding:
                                    EdgeInsets.only(left: 30.0, right: 50.0),
